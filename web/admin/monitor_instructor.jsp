...
<html lang="en">
        ...
        function showDetails(instructorId) {
            ...
            fetch('monitor-instructor?action=details&id=' + instructorId)
                ...
                .then(function(xmlText) {
                    ...
                    // Update profile image - PERBAIKAN DI SINI
                    ...
                    // Update certification - PERBAIKAN DI SINI
                    ...
                    document.getElementById('statTotalClasses').textContent = getXmlValue(xmlDoc, 'totalClasses');
                    document.getElementById('statCancelled').textContent = getXmlValue(xmlDoc, 'cancelledClasses');
                    document.getElementById('statAvgRating').textContent = getXmlValue(xmlDoc, 'avgRating');
                    document.getElementById('statFeedbacks').textContent = getXmlValue(xmlDoc, 'feedbackCount');
        ...
        function showPerformance() {
            ...
            fetch('monitor-instructor?action=performance&id=' + currentInstructorId + '&period=all')
                ...
                .then(function(xmlText) {
                    ...
                    document.getElementById('performanceInstructorName').textContent = getXmlValue(xmlDoc, 'instructorName');
    ...
    function getXmlValue(xmlDoc, tagName) {
        ...
        function updateCharts(xmlDoc) {
            ...
            chartInstances.categoryChart = new Chart(categoryCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [teaching, communication, support, punctuality],
            ...
            // Monthly Trend Chart (dummy data for now)
            ...
            // Class Distribution Chart (dummy data for now)
